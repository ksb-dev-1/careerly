      ...
      <section className="relative rounded overflow-hidden">
        <div className="p-4 md:p-6 border flex flex-col gap-4 rounded">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between">
            <div>
              <p className="text-xl font-extrabold">{name || "No name"}</p>
              <p className="font-semibold">{email || "No email"}</p>
            </div>
            {isLoading ? (
              ...
              resumeUrl && (
                <a
                  ...
                  className="mt-2 sm:mt-0 underline text-primary hover:opacity-80 dark:hover:opacity-80 transition-opacity font-semibold"
