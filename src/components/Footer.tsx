...
export default function Footer() {
  return (
    <footer className="border-t bg-light dark:bg-dark h-16">
      <div className="max-w-5xl w-full mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between">
